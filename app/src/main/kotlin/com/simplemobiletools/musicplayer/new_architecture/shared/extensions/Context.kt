...
import com.simplemobiletools.musicplayer.new_architecture.shared.helpers.ExternalStorageProviderHack
import com.simplemobiletools.musicplayer.new_architecture.shared.helpers.FONT_SIZE_LARGE
import com.simplemobiletools.musicplayer.new_architecture.shared.helpers.FONT_SIZE_MEDIUM
import com.simplemobiletools.musicplayer.new_architecture.shared.helpers.FONT_SIZE_SMALL
import com.simplemobiletools.musicplayer.new_architecture.shared.helpers.MyContentProvider
import com.simplemobiletools.musicplayer.new_architecture.shared.helpers.MyWidgetProvider
import com.simplemobiletools.musicplayer.new_architecture.shared.helpers.PERMISSION_ACCESS_COARSE_LOCATION
import com.simplemobiletools.musicplayer.new_architecture.shared.helpers.PERMISSION_ACCESS_FINE_LOCATION
import com.simplemobiletools.musicplayer.new_architecture.shared.helpers.PERMISSION_CALL_PHONE
import com.simplemobiletools.musicplayer.new_architecture.shared.helpers.PERMISSION_CAMERA
import com.simplemobiletools.musicplayer.new_architecture.shared.helpers.PERMISSION_GET_ACCOUNTS
import com.simplemobiletools.musicplayer.new_architecture.shared.helpers.PERMISSION_MEDIA_LOCATION
import com.simplemobiletools.musicplayer.new_architecture.shared.helpers.PERMISSION_POST_NOTIFICATIONS
import com.simplemobiletools.musicplayer.new_architecture.shared.helpers.PERMISSION_READ_CALENDAR
import com.simplemobiletools.musicplayer.new_architecture.shared.helpers.PERMISSION_READ_CALL_LOG
import com.simplemobiletools.musicplayer.new_architecture.shared.helpers.PERMISSION_READ_CONTACTS
import com.simplemobiletools.musicplayer.new_architecture.shared.helpers.PERMISSION_READ_MEDIA_AUDIO
import com.simplemobiletools.musicplayer.new_architecture.shared.helpers.PERMISSION_READ_MEDIA_IMAGES
import com.simplemobiletools.musicplayer.new_architecture.shared.helpers.PERMISSION_READ_MEDIA_VIDEO
import com.simplemobiletools.musicplayer.new_architecture.shared.helpers.PERMISSION_READ_MEDIA_VISUAL_USER_SELECTED
import com.simplemobiletools.musicplayer.new_architecture.shared.helpers.PERMISSION_READ_PHONE_STATE
import com.simplemobiletools.musicplayer.new_architecture.shared.helpers.PERMISSION_READ_SMS
import com.simplemobiletools.musicplayer.new_architecture.shared.helpers.PERMISSION_READ_STORAGE
import com.simplemobiletools.musicplayer.new_architecture.shared.helpers.PERMISSION_READ_SYNC_SETTINGS
import com.simplemobiletools.musicplayer.new_architecture.shared.helpers.PERMISSION_RECORD_AUDIO
import com.simplemobiletools.musicplayer.new_architecture.shared.helpers.PERMISSION_SEND_SMS
import com.simplemobiletools.musicplayer.new_architecture.shared.helpers.PERMISSION_WRITE_CALENDAR
import com.simplemobiletools.musicplayer.new_architecture.shared.helpers.PERMISSION_WRITE_CALL_LOG
import com.simplemobiletools.musicplayer.new_architecture.shared.helpers.PERMISSION_WRITE_CONTACTS
import com.simplemobiletools.musicplayer.new_architecture.shared.helpers.PERMISSION_WRITE_STORAGE
import com.simplemobiletools.musicplayer.new_architecture.shared.helpers.PREFS_KEY
...
import com.simplemobiletools.musicplayer.new_architecture.shared.helpers.SD_OTG_PATTERN
import com.simplemobiletools.musicplayer.new_architecture.shared.helpers.SD_OTG_SHORT
import com.simplemobiletools.musicplayer.new_architecture.shared.helpers.SimpleMediaScanner
import com.simplemobiletools.musicplayer.new_architecture.shared.helpers.TIME_FORMAT_12
import com.simplemobiletools.musicplayer.new_architecture.shared.helpers.TIME_FORMAT_24
import com.simplemobiletools.musicplayer.new_architecture.shared.helpers.TRACK_STATE_CHANGED
import com.simplemobiletools.musicplayer.new_architecture.shared.helpers.appIconColorStrings
import com.simplemobiletools.musicplayer.new_architecture.shared.helpers.ensureBackgroundThread
import com.simplemobiletools.musicplayer.new_architecture.shared.helpers.isOnMainThread
...
import com.simplemobiletools.musicplayer.new_architecture.shared.ui.views.MyAppCompatSpinner
import com.simplemobiletools.musicplayer.new_architecture.shared.ui.views.MyAutoCompleteTextView
import com.simplemobiletools.musicplayer.new_architecture.shared.ui.views.MyButton
import com.simplemobiletools.musicplayer.new_architecture.shared.ui.views.MyCompatRadioButton
import com.simplemobiletools.musicplayer.new_architecture.shared.ui.views.MyEditText
import com.simplemobiletools.musicplayer.new_architecture.shared.ui.views.MyFloatingActionButton
import com.simplemobiletools.musicplayer.new_architecture.shared.ui.views.MySeekBar
import com.simplemobiletools.musicplayer.new_architecture.shared.ui.views.MyTextInputLayout
