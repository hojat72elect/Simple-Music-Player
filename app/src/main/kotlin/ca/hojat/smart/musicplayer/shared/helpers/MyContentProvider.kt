...
class MyContentProvider {
    companion object {
        private const val AUTHORITY = "ca.hojat.smart.musicplayer.provider"
        const val SHARED_THEME_ACTIVATED = "ca.hojat.smart.musicplayer.SHARED_THEME_ACTIVATED"
        const val SHARED_THEME_UPDATED = "ca.hojat.smart.musicplayer.SHARED_THEME_UPDATED"
